...
* EMMO extensions that are required by the device ontology *

:details: python module that defines an ontology of common device classes that are used in a scientific lab, based on EMMOntoPy
...
class EMMOExtensionTBox:
    ...
    def export(self, path: str = ".", format='turtle') -> None:
        """save ontology """
        export_ontology(ontology=self.emmo, path=path, onto_base_filename='labop_device_emmo', format=format, emmo_url=self.emmo_url)
    ...
    def define_ontology(self):
        ...
        with self.emmo:
            ...
            class Force(self.emmo.Force):
                """Force of a device, e.g. for screw caps""" 
            ...
            class Pressure(self.emmo.Pressure):
                """Pressure of a device, e.g. for screw caps""" 
                # add quantity“Scoping:
            ...
            class Torque(self.emmo.Torque):
                """Torque of a device, e.g. for screw caps""" 
                # add quantity“Scoping:
